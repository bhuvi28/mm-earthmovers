        ...
        <div className="grid md:grid-cols-4 gap-8 md:gap-12">
          ...
          <div className="col-span-1">
            <div className="mb-6 flex items-center h-14">
              ...
              />
              <span className="text-xl font-bold text-white tracking-wide">MM Earthmovers</span>
            </div>
          ...
          <div>
            <h4 className="text-xs font-bold uppercase tracking-widest text-amber-500 mb-6 flex items-center h-14">Quick Links</h4>
          ...
          {/* Column 3: Contact */}
          <div>
            <h4 className="text-xs font-bold uppercase tracking-widest text-amber-500 mb-6 flex items-center h-14">Contact</h4>
            <ul className="space-y-4 text-base text-gray-300">
          ...
          <div>
            <h4 className="text-xs font-bold uppercase tracking-widest text-amber-500 mb-6 flex items-center h-14">Connect With Us</h4>
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://www.instagram.com/m.m.earthmovers/" target="_blank" rel="noopener noreferrer" className="bg-gray-800 border border-gray-700 text-gray-400 p-2.5 rounded-lg hover:bg-[#E4405F] hover:border-[#E4405F] hover:text-white transition-all duration-300 transform hover:-translate-y-1">
