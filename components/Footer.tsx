      ...
      <div className="container mx-auto px-6 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          <div className="col-span-1">
            ...
            <p className="text-gray-500 mt-4 text-sm">GSTIN: --</p>
          </div>
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#why-choose-us" className="text-gray-400 hover:text-amber-500">Why Choose Us</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>1, Metcalf Lane, Esplanade, Kolkata 700001</li>
              <li>+91 8334887009</li>
              <li>mmearthmovers@gmail.com</li>
            </ul>
          </div>
          <div>
