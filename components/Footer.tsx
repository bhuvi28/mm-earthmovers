    ...
    <footer className="bg-gray-900 border-t border-gray-800 shadow-inner">
      <div className="container mx-auto px-6 py-12 md:py-16">
        <div className="grid md:grid-cols-4 gap-8 md:gap-12">
          ...
          <div>
            <h4 className="text-xs font-bold uppercase tracking-widest text-amber-500 mb-6 flex items-center h-8">Quick Links</h4>
          ...
          {/* Column 3: Contact */}
          <div>
            <h4 className="text-xs font-bold uppercase tracking-widest text-amber-500 mb-6 flex items-center h-8">Contact</h4>
            <ul className="space-y-4 text-sm text-gray-400">
          ...
          <div>
            <h4 className="text-xs font-bold uppercase tracking-widest text-amber-500 mb-6 flex items-center h-8">Connect With Us</h4>
            <p className="text-sm text-gray-400 mb-6 leading-relaxed">Follow us on social media for the latest updates on parts and services.</p>
            <div className="flex space-x-4">
              <a href="https://www.facebook.com/profile.php?id=61578501061236#" target="_blank" rel="noopener noreferrer" className="bg-gray-800 border border-gray-700 text-gray-400 p-2.5 rounded-lg hover:bg-amber-500 hover:border-amber-500 hover:text-gray-900 transition-all duration-300 transform hover:-translate-y-1">
                <span className="sr-only">Facebook</span>
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" />
                </svg>
              </a>
              <a href="https://www.instagram.com/m.m.earthmovers/" target="_blank" rel="noopener noreferrer" className="bg-gray-800 border border-gray-700 text-gray-400 p-2.5 rounded-lg hover:bg-amber-500 hover:border-amber-500 hover:text-gray-900 transition-all duration-300 transform hover:-translate-y-1">
              ...
              <a href="https://www.linkedin.com/company/m-m-earthmovers/" target="_blank" rel="noopener noreferrer" className="bg-gray-800 border border-gray-700 text-gray-400 p-2.5 rounded-lg hover:bg-amber-500 hover:border-amber-500 hover:text-gray-900 transition-all duration-300 transform hover:-translate-y-1">
