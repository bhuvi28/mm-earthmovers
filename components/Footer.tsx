      ...
      <div className="container mx-auto px-6 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          <div className="col-span-1">
            <h3 className="text-xl font-extrabold text-white mb-4">MM <span className="text-amber-500">Earthmovers</span></h3>
            <p className="text-gray-400">Your premier supplier for genuine loader and motor grader parts. Built on trust and reliability.</p>
            <p className="text-gray-500 mt-4 text-sm">GSTIN: 29ABCDE1234F1Z5</p>
          </div>
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#products-overview" className="text-gray-400 hover:text-amber-500">Products</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>123 Industrial Park, Metropolis</li>
              <li>+1 (555) 123-4567</li>
              <li>sales@mmearthmovers.com</li>
            </ul>
          </div>
          <div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center text-gray-500">
          <p>&copy; 2024 MM Earthmovers. All Rights Reserved.</p>
        </div>
      </div>
    </footer>
  )
