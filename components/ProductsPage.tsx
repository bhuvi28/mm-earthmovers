                ...
                >
                  ...
                  <div className="p-5 flex-grow flex flex-col">
                    ...
                    <button
                      ...
                      className="w-full py-2.5 bg-amber-600 hover:bg-amber-700 text-white font-medium rounded-lg transition-all duration-200 hover:shadow-md mt-auto flex items-center justify-center gap-2"
                    >
