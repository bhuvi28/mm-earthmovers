export default function WhyChooseUs() {
  const features = [
    ...
    {
      title: 'Wide Range',
      description: 'An extensive catalog covering all major brands including HM, BEML, L&T, XCMG, JCB, and more.',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
    ...
    {
      title: 'Fast Delivery',
      description: 'Efficient logistics and worldwide shipping to get your parts delivered quickly and minimize downtime.',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
          ...
          {features.map((feature, index) => (
            ...
            >
              ...
              <div className="text-center">
                ...
                <div className="text-gray-600 mb-5 leading-relaxed text-sm">
                  {feature.description}
                </div>
